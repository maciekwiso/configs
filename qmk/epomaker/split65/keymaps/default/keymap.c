...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_BASE] = LAYOUT( /* Base */
        ...
        KC_LCTL,  KC_LCMD,  KC_LALT,  KC_SPC,                                 KC_SPC,   KC_RALT,  MO(MAC_FN),KC_RCTL,                     KC_LEFT,  KC_DOWN, KC_RGHT),
    ...
    [MAC_FN] = LAYOUT( /* Base */
        ...
        KC_CAPS,  KC_A,     TO(MAC_BASE), KC_D, KC_F,     KC_G,               KC_H,     KC_J,     KC_K,     KC_L,      RGB_SAD,  RGB_SAI, KC_ENT,             KC_HOME,
    ...
    [WIN_BASE] = LAYOUT( /* Base */
        ...
        KC_LCTL,  HM_ALIN,  KC_BSPC,  HM_SPC,                                 HM_RSFT,  MO(WIN_FN),KC_LCTL, KC_RALT,                      KC_LEFT,  KC_DOWN, KC_RGHT),
