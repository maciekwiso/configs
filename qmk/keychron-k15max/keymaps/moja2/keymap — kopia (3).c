...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT_ansi_90(
        ...
        _______,   KC_TAB,   S(KC_BSLS),HM2_W,   S(KC_LBRC),S(KC_RBRC),S(KC_MINS),KC_PGUP,KC_HOME, S(KC_2),  S(KC_3),  S(KC_4),  S(KC_5),  S(KC_6),  _______,            KC_PGDN,
        _______,   KC_CAPS,  HM2_A,    HM2_S,    HM2_D,    HM2_F,    S(KC_QUOT),KC_LEFT, KC_DOWN,  KC_UP,    KC_RGHT,  S(KC_SCLN),S(KC_8),           _______,            KC_END,
        _______,   _______,            KC_MINS,  S(KC_EQL),KC_LBRC,  KC_RBRC,  KC_QUOT,  BAT_LVL,  KC_PGDN,  KC_END,   S(KC_COMM),S(KC_DOT),KC_BSLS, _______,    _______,
        _______,   _______,  _______,            _______,  _______,  _______,                      _______,            _______,  _______,             _______,   _______,  _______),
