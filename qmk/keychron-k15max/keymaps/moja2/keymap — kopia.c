...
#define HM_M KC_M
#define HM_N RGUI_T(KC_N)   //  acts as GUI (Cmd/Win) when held
#define HM_SCLN LT(WIN_FN, KC_SCLN)

#define HM2_F LCTL_T(KC_0)
#define HM2_D LSFT_T(KC_9)
#define HM2_S LALT_T(KC_EQUAL)
#define HM2_A S(KC_MINS)
#define HM2_W LT(WIN_BASE,KC_7)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_BASE] = LAYOUT_ansi_90(
        ...
        MC_2,     KC_TAB,   LT(MOD1,KC_Q),     HM_W,     HM_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,            KC_END,
        ...
        KC_F16,   KC_LCTL,  KC_LWIN,            KC_LALT,  KC_SPC,  MO(WIN_FN),                    TG(WIN_FN),             KC_RALT,  KC_RCTL,            KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [WIN_FN] = LAYOUT_ansi_90(
        ...
        _______,  BL_TOGG,  S(KC_BSLS),  HM2_W,  S(KC_1),    S(KC_LBRC),  S(KC_RBRC),  S(KC_2),  KC_PGUP,  KC_PGDN,  S(KC_3),  S(KC_4),  S(KC_8),  _______,  _______,            KC_PGDN,
